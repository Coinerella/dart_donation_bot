...
class MarismaClient extends $grpc.Client {
  ...
  static final _$getAddressUtxoHistoryList =
      $grpc.ClientMethod<$0.AddressListRequest, $0.AddressUtxoHistoryReply>(
          '/marisma.Marisma/GetAddressUtxoHistoryList',
          ($0.AddressListRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.AddressUtxoHistoryReply.fromBuffer(value));
  ...
  static final _$blockHashStream =
      $grpc.ClientMethod<$0.BlockHashStreamRequest, $0.BlockHashStreamReply>(
          '/marisma.Marisma/BlockHashStream',
          ($0.BlockHashStreamRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.BlockHashStreamReply.fromBuffer(value));
  static final _$addressStatusStream =
      $grpc.ClientMethod<$0.AddressRequest, $0.AddressStatusStreamReply>(
          '/marisma.Marisma/AddressStatusStream',
          ($0.AddressRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.AddressStatusStreamReply.fromBuffer(value));
  static final _$addressScanStream =
      $grpc.ClientMethod<$0.AddressRequest, $0.AddressScanStreamReply>(
          '/marisma.Marisma/AddressScanStream',
          ($0.AddressRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.AddressScanStreamReply.fromBuffer(value));
  static final _$addressUtxosStream =
      $grpc.ClientMethod<$0.AddressListRequest, $0.AddressUtxosStreamReply>(
          '/marisma.Marisma/AddressUtxosStream',
          ($0.AddressListRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.AddressUtxosStreamReply.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.AddressUtxoHistoryReply> getAddressUtxoHistoryList(
      $0.AddressListRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getAddressUtxoHistoryList, request,
        options: options);
  }
  ...
  $grpc.ResponseStream<$0.BlockHashStreamReply> blockHashStream(
      $0.BlockHashStreamRequest request,
      {$grpc.CallOptions? options}) {
    return $createStreamingCall(
        _$blockHashStream, $async.Stream.fromIterable([request]),
        options: options);
  }

  $grpc.ResponseStream<$0.AddressStatusStreamReply> addressStatusStream(
      $async.Stream<$0.AddressRequest> request,
      {$grpc.CallOptions? options}) {
    return $createStreamingCall(_$addressStatusStream, request,
        options: options);
  }

  $grpc.ResponseStream<$0.AddressScanStreamReply> addressScanStream(
      $async.Stream<$0.AddressRequest> request,
      {$grpc.CallOptions? options}) {
    return $createStreamingCall(_$addressScanStream, request, options: options);
  }

  $grpc.ResponseStream<$0.AddressUtxosStreamReply> addressUtxosStream(
      $async.Stream<$0.AddressListRequest> request,
      {$grpc.CallOptions? options}) {
    return $createStreamingCall(_$addressUtxosStream, request,
        options: options);
  }
}
...
abstract class MarismaServiceBase extends $grpc.Service {
  ...
  MarismaServiceBase() {
    ...
    $addMethod(
        $grpc.ServiceMethod<$0.AddressListRequest, $0.AddressUtxoHistoryReply>(
    ...
    $addMethod(
        $grpc.ServiceMethod<$0.BlockHashStreamRequest, $0.BlockHashStreamReply>(
            'BlockHashStream',
            blockHashStream_Pre,
            false,
            true,
            ($core.List<$core.int> value) =>
                $0.BlockHashStreamRequest.fromBuffer(value),
            ($0.BlockHashStreamReply value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$0.AddressRequest, $0.AddressStatusStreamReply>(
            'AddressStatusStream',
            addressStatusStream,
            true,
            true,
    ...
    $addMethod(
        $grpc.ServiceMethod<$0.AddressRequest, $0.AddressScanStreamReply>(
            'AddressScanStream',
            addressScanStream,
            true,
            true,
    ...
    $addMethod(
        $grpc.ServiceMethod<$0.AddressListRequest, $0.AddressUtxosStreamReply>(
            'AddressUtxosStream',
            addressUtxosStream,
            true,
            true,
  ...
  $async.Future<$0.AddressUtxoHistoryReply> getAddressUtxoHistoryList_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.AddressListRequest> request) async {
  ...
  $async.Stream<$0.BlockHashStreamReply> blockHashStream_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.BlockHashStreamRequest> request) async* {
  ...
  $async.Future<$0.AddressNumberOfUtxosReply> getAddressNumberOfUtxos(
      $grpc.ServiceCall call, $0.AddressRequest request);
  $async.Future<$0.AddressUtxoHistoryReply> getAddressUtxoHistoryList(
      $grpc.ServiceCall call, $0.AddressListRequest request);
  ...
  $async.Stream<$0.BlockHashStreamReply> blockHashStream(
      $grpc.ServiceCall call, $0.BlockHashStreamRequest request);
  $async.Stream<$0.AddressStatusStreamReply> addressStatusStream(
      $grpc.ServiceCall call, $async.Stream<$0.AddressRequest> request);
  $async.Stream<$0.AddressScanStreamReply> addressScanStream(
      $grpc.ServiceCall call, $async.Stream<$0.AddressRequest> request);
  $async.Stream<$0.AddressUtxosStreamReply> addressUtxosStream(
      $grpc.ServiceCall call, $async.Stream<$0.AddressListRequest> request);
}
